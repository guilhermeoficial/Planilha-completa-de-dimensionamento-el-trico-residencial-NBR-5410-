...
const QUESTOES_BASE: any[] = [
  ...
  { id: "ce13", areaGrande: "Eletrotécnica", assunto: "NBR 5410", banca: "CESGRANRIO (estilo, Certo/Errado)", ano: 2023, dificuldade: "Difícil",
    ...
    alternativas: ["Certo", "Errado"], respostaCorreta: 1,
    explicacao: "Previsão de TUG pela NBR 5410: mínimo de 1 tomada a cada 5 metros de perímetro, e no mínimo 1 por cômodo. Para perímetro de 18 m: $$N_{min} = \lceil 18/5 \rceil = 4$$ tomadas. As TUGs são dimensionadas em 600 VA cada ponto." },
  ...
  { id: 'n2', areaGrande: 'Eletrotécnica', assunto: 'Método dos dois wattímetros', banca: 'CESGRANRIO (estilo)', ano: 2024, dificuldade: 'Difícil',
    ...
    alternativas: ['Certo', 'Errado'], respostaCorreta: 0,
    explicacao: "Para $$FP = 0{,}5$$ $$(\varphi = 60°)$$ no método dos dois wattímetros: $$W_2 = V_L I_L \cos(30° + 60°) = V_L I_L \cos 90° = 0$$. Portanto a leitura de um dos wattímetros é nula e $$P_{total} = W_1 + W_2 = W_1$$. A tangente do ângulo de desfasagem vale $$\tan\varphi = \sqrt{3}\dfrac{W_1 - W_2}{W_1 + W_2}$$." },
  ...
  { id: "e37", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$I_{out} = \dfrac{P}{V_{out}} = \dfrac{10000}{200} = 50\text{ A}$$. $$I_{in} = \dfrac{P}{V_{in}} = \dfrac{10000}{240} \approx 41{,}7\text{ A}$$. Durante a descida do elevador, o motor opera como gerador (frenagem regenerativa), devolvendo energia à rede elétrica — modo de operação de gerador com escorregamento negativo." },
  ...
  { id: "e38", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Motor CC shunt (derivação): campo em paralelo com a armadura. $$n \approx \dfrac{V - I_a R_a}{k\Phi}$$. A ligação curta (short shunt) coloca a resistência série também em paralelo com o campo, enquanto na ligação longa (long shunt) o campo fica em paralelo com a armadura mais a série." },
  ...
  { id: "e39", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$RT = \dfrac{V_{vazio} - V_{carga}}{V_{carga}} \times 100 = \dfrac{240 - 220}{220} \times 100 \approx 9{,}1\%$$. A regulação indica quanto a tensão cai do vazio à plena carga — quanto menor, melhor a qualidade do transformador. Transformadores modernos de distribuição têm RT entre 2% e 5%." },
  ...
  { id: "e51", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Médio",
    ...
    explicacao: "Lei de Ampère: $$\oint_C \vec{H} \cdot d\vec{l} = \sum I_{encl}$$. Para N espiras com corrente I envolvidas pelo caminho fechado C: $$H \cdot l = N \cdot I \Rightarrow H = \dfrac{NI}{l}$$. O campo magnético B = μH. Essa lei é a base do cálculo de campos em solenoides, toroides e eletroímãs." },
  ...
  { id: "e53", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instrumentação", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Médio",
    ...
    explicacao: "Com n voltas do condutor antes de fechar a garra do alicate amperímetro, a leitura é multiplicada por n. A corrente real é: $$I_{real} = \dfrac{\text{Leitura}}{n} = \dfrac{2\text{ A}}{5} = 0{,}4\text{ A}$$. Técnica usada para medir correntes muito baixas, abaixo da resolução mínima do equipamento." },
  ...
  { id: "e77", inedita: true, areaGrande: "Eletrotécnica", assunto: "NBR 5410", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "A NBR 5410:2004 §6.2.7 estabelece queda de tensão máxima de **4%** nos circuitos terminais e de **7%** total entre o ponto de entrega da concessionária e qualquer ponto de utilização. Portanto, a afirmativa que diz 7% para circuitos terminais está **errada** — os 7% se referem ao limite acumulado entre a origem geral e o ponto de uso, incluindo ramais e circuitos terminais somados." },
  ...
  { id: "e79", inedita: true, areaGrande: "Eletrotécnica", assunto: "NBR 5410", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Corrente de referência corrigida para seleção do cabo pelo fator de correção de temperatura/agrupamento: $$I_{ref} = \dfrac{I_b}{F_c} = \dfrac{28}{0{,}70} = 40\text{ A}$$. O cabo deve ter $$I_z \geq 40\text{ A}$$. Pela Tabela 36 da NBR 5410 (PVC, 3 condutores, embutido): seção de 10 mm² → $$I_z = 44\text{ A}$$ ✓." },
  ...
  { id: "e81", inedita: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "O relé térmico deve ser ajustado para a **corrente nominal** do motor, indicada na placa de identificação. Assim: $$I_{ajuste} = I_{nom}$$. Ajustar abaixo da corrente nominal causaria desligamentos indevidos; acima, permitiria sobrecargas prejudiciais ao enrolamento." },
  ...
  { id: "e83", inedita: true, areaGrande: "Eletrotécnica", assunto: "Disjuntores e seletividade", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Corrente de curto-circuito mínima pelo critério térmico: $$I_{cc} = \dfrac{k \cdot S}{\sqrt{t}}$$. Para cobre com isolação PVC a 70°C: k = 143. $$I_{cc,min} = \dfrac{143 \times 35}{\sqrt{0{,}5}} = \dfrac{5005}{0{,}707} \approx 7079\text{ A}$$. Esse critério garante que o condutor suporte a energia $$I^2 t$$ no curto-circuito sem dano térmico." },
  ...
  { id: "e86", inedita: true, areaGrande: "Eletrotécnica", assunto: "Aterramento", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Resistência de aterramento de haste vertical pela fórmula de Dwight: $$R = \dfrac{\rho}{2\pi L}\left[\ln\dfrac{4L}{d} - 1\right] = \dfrac{100}{2\pi \times 2{,}4}\left[\ln\dfrac{4 \times 2{,}4}{0{,}019} - 1\right] \approx \dfrac{100}{15{,}08}\times(\ln504 - 1) \approx 6{,}63 \times 5{,}22 \approx 34{,}6\,\Omega$$." },
  ...
  { id: "e96", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I_{n,BT} = \dfrac{S}{V_2} = \dfrac{50000}{240} \approx 208{,}3\text{ A}$$. Corrente de excitação percentual: $$I_0\% = \dfrac{I_0}{I_{n,BT}} \times 100 = \dfrac{5}{208{,}3} \times 100 \approx 2{,}4\%$$. Componente ativa: $$I_c = \dfrac{P_0}{V_0} = \dfrac{40}{240} \approx 0{,}167\text{ A}$$ (perdas no ferro)." },
  ...
  { id: "e98", inedita: true, areaGrande: "Eletrotécnica", assunto: "Automação industrial", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$\text{Sensibilidade} = \dfrac{\Delta T}{\Delta I} = \dfrac{400 - 0°C}{20 - 4\text{ mA}} = \dfrac{400}{16} = 25°C/\text{mA}$$. Corrente a 100°C: $$I = 4 + \dfrac{100}{25} = 4 + 4 = 8\text{ mA}$$. Padrão 4-20 mA: 4 mA = 0°C (zero da faixa) e 20 mA = 400°C (fundo de escala)." },
  ...
  { id: "e101", inedita: true, areaGrande: "Eletrotécnica", assunto: "Circuitos CA", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Em ressonância paralela (tanque LC): $$f_0 = \dfrac{1}{2\pi\sqrt{LC}}$$. Na ressonância, a reatância indutiva iguala a capacitiva, e a impedância equivalente atinge valor **máximo** (teoricamente infinito para circuito ideal). A corrente de linha é **mínima** na ressonância paralela, ao contrário da série onde a corrente é máxima." },
  ...
  { id: "e102", inedita: true, temImagem: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Passo 1 — Corrente nominal no primário: $$I_{n1} = \dfrac{S}{V_1} = \dfrac{10000}{2400} \approx 4{,}17\text{ A}$$ (atenção: esse valor em amperes NÃO é o Zcc% — pegadinha da alternativa D!). Passo 2 — Impedância de base referida ao primário: $$Z_{base} = \dfrac{V_1^2}{S} = \dfrac{2400^2}{10000} = 576\,\Omega$$. Passo 3 — Módulo da impedância série de curto-circuito: $$Z_{cc} = \sqrt{R_{eq}^2 + X_{eq}^2} = \sqrt{3^2 + 5^2} = \sqrt{34} \approx 5{,}83\,\Omega$$. Passo 4 — Impedância percentual: $$Z_{cc}\% = \dfrac{Z_{cc}}{Z_{base}} \times 100 = \dfrac{5{,}83}{576} \times 100 \approx 1{,}01\%$$. Resposta: alternativa C." },
  ...
  { id: "e103", inedita: true, areaGrande: "Eletrotécnica", assunto: "Sistemas trifásicos", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$P_{total} = 10 + 15 = 25\text{ kW}$$. $$Q_Y = 10 \times \tan(\arccos 0{,}8) = 10 \times 0{,}75 = 7{,}5\text{ kvar}$$. $$Q_{\Delta} = 15 \times \tan(\arccos 0{,}75) = 15 \times 0{,}882 \approx 13{,}2\text{ kvar}$$. $$Q_{total} = 20{,}7\text{ kvar}$$. $$S = \sqrt{P^2 + Q^2} = \sqrt{625 + 428} = \sqrt{1053} \approx 32{,}4\text{ kVA}$$." },
  ...
  { id: "e104", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$N_s = 1800\text{ rpm}$$. Operação como gerador: escorregamento negativo $$s = -0{,}04$$. $$N = N_s(1 - s) = 1800 \times 1{,}04 = 1872\text{ rpm}$$. O rotor gira acima da velocidade síncrona. Para forçar isso, uma máquina primária (turbina, motor) deve tracionar o gerador acima de 1800 rpm." },
  ...
  { id: "e105", inedita: true, areaGrande: "Eletrotécnica", assunto: "Geração e transmissão", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$S = \dfrac{P}{FP} = \dfrac{50}{0{,}9} \approx 55{,}6\text{ MVA}$$. $$I = \dfrac{S}{\sqrt{3} \times V} = \dfrac{55{,}6 \times 10^6}{\sqrt{3} \times 138 \times 10^3} = \dfrac{55{,}6 \times 10^6}{239{,}0 \times 10^3} \approx 232{,}5\text{ A}$$." },
  ...
  { id: "e106", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$V_{out} = D \times V_{in}$$ (conversor Buck/Abaixador): $$V_{out} = 0{,}625 \times 48 = 30\text{ V}$$. O conversor Buck (abaixador) produz tensão de saída **menor** que a entrada: $$V_{out} = D \times V_{in}$$, onde D é o ciclo de trabalho (duty cycle), $$0 < D < 1$$." },
  ...
  { id: "e107", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Conversor Boost (elevador de tensão): $$V_{out} = \dfrac{V_{in}}{1 - D}$$. Com $$V_{in} = 12\text{ V}$$ e $$D = 0{,}6$$: $$V_{out} = \dfrac{12}{1 - 0{,}6} = \dfrac{12}{0{,}4} = 30\text{ V}$$. O conversor Boost sempre produz tensão de saída **maior** que a entrada." },
  ...
  { id: "e108", inedita: true, temImagem: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$R = \dfrac{\rho L}{A} = \dfrac{1{,}72\times10^{-8} \times 40}{2{,}5\times10^{-6}} = \dfrac{6{,}88\times10^{-7}}{2{,}5\times10^{-6}} = 0{,}275\,\Omega$$. $$I = \dfrac{P}{V} = \dfrac{4000}{127} \approx 31{,}5\text{ A}$$. $$\Delta V = R \times I = 0{,}275 \times 31{,}5 \approx 8{,}7\text{ V}$$. $$\Delta V\% = \dfrac{8{,}7}{127} \times 100 \approx 6{,}8\%$$. Nota: comprimento total = ida + volta = 40 m (já inclui os dois condutores)." },
  ...
  { id: "e111", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Partida Estrela-Triângulo: na chave estrela, a tensão por fase é reduzida a $$V_{fase,Y} = V_L / \sqrt{3}$$. A corrente de partida é reduzida para $$1/3$$ da corrente de partida direta em triângulo. O torque inicial também é reduzido para $$1/3$$ do torque de partida direta." },
  ...
  { id: "e113", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$P = S \times FP = 10{,}000 \times 0{,}9 = 9{,}000\text{ kW}$$. $$I = \dfrac{S}{\sqrt{3} \times V} = \dfrac{10000}{\sqrt{3} \times 220} = \dfrac{10000}{381{,}1} \approx 26{,}2\text{ A}$$. Corrente da carga: $$I_{carga} = \dfrac{P}{\sqrt{3} \times V \times FP} = \dfrac{9000}{\sqrt{3} \times 220 \times 0{,}9} = \dfrac{9000}{343} \approx 26{,}2\text{ A}$$." },
  ...
  { id: "e114", inedita: true, areaGrande: "Eletrotécnica", assunto: "Geração e transmissão", banca: "Voltis Original", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I_n = \dfrac{S}{\sqrt{3} \times V} = \dfrac{20 \times 10^6}{\sqrt{3} \times 13{,}8 \times 10^3} = \dfrac{20 \times 10^6}{23{,}9 \times 10^3} \approx 836{,}7\text{ A}$$. Corrente de CC: $$I_{cc} = \dfrac{I_n}{Z_{cc}\%} = \dfrac{836{,}7}{0{,}08} \approx 10{,}5\text{ kA}$$." },
...
// 50 questões estilo CESPE/CESGRANRIO para append no questoes-data.ts
  ...
  { id: "e117", inedita: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$I_n \approx \dfrac{P}{\sqrt{3} \times V \times FP \times \eta} = \dfrac{22000}{\sqrt{3} \times 380 \times 0{,}86 \times 0{,}92} \approx 44{,}7\text{ A}$$. Corrente de partida direta: $$I_p = K_p \times I_n = 7 \times 44{,}7 \approx 313\text{ A}$$. Disjuntor curva D: desarmamento magnético entre 10 e 20×$$I_n$$ — 313A está dentro de $$[447\text{ A}, 894\text{ A}]$$ — curva D adequada." },
  ...
  { id: "e118", inedita: true, areaGrande: "Eletrotécnica", assunto: "Sistemas trifásicos", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Com um capacitor aberto em banco trifásico em triângulo: a fase com o capacitor aberto não contribui, restando apenas dois capacitores operando. A potência total cai para $$P_{nova} = \dfrac{2}{3} P_{original}$$? Não — na ligação triângulo, a tensão sobre os dois capacitores restantes pode variar. Na prática com banco em triângulo: potência cai para aproximadamente **50%** do valor nominal." },
  ...
  { id: "e119", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Em transformador de polaridade subtrativa: H1 e X1 têm polaridade marcada no mesmo sentido. Ligando H1 a X1: $$V_{medido} = V_1 - V_2 = 2400 - 240 = 2160\text{ V}$$. Na polaridade aditiva (H1 oposto a X1): $$V_{medido} = V_1 + V_2 = 2640\text{ V}$$. O ensaio de polaridade é fundamental antes de ligar transformadores em paralelo." },
  ...
  { id: "e120", inedita: true, areaGrande: "Eletrotécnica", assunto: "Disjuntores e seletividade", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "A queda de tensão transitória durante a partida de motores é causada pela alta corrente de partida: $$\Delta V = I_p \times Z_{rede}$$. Para minimizar o impacto em outros equipamentos: usar partida suave (soft-starter) ou partida estrela-triângulo, que reduz $$I_p$$ a 1/3 e minimiza a perturbação na rede." },
  ...
  { id: "e121", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Tensão de flutuação de baterias chumbo-ácido: $$V_{cel} = 2{,}25\text{ V}$$ a $$2{,}30\text{ V}$$. Bateria 12V (6 células): $$V_{float} = 6 \times 2{,}25 = 13{,}5\text{ V}$$. Durante a flutuação, a bateria permanece sempre carregada para operação em caso de falta de energia (no-break/UPS)." },
  ...
  { id: "e125", inedita: true, areaGrande: "Eletrotécnica", assunto: "Geração e transmissão", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I = \dfrac{P}{\sqrt{3} \times V \times FP} = \dfrac{8 \times 10^6}{\sqrt{3} \times 69{,}0 \times 10^3 \times 0{,}92} = \dfrac{8 \times 10^6}{109{,}9 \times 10^3} \approx 72{,}8\text{ A}$$." },
  ...
  { id: "e126", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Leis de semelhança para bombas e ventiladores — variação de rotação: $$\dfrac{P_2}{P_1} = \left(\dfrac{n_2}{n_1}\right)^3 = \left(\dfrac{30}{60}\right)^3 = \left(\dfrac{1}{2}\right)^3 = \dfrac{1}{8}$$. Reduzindo a rotação à metade, a potência cai para 12,5% — economia de **87,5%** de energia. Por isso VFDs (Inversores de Frequência) são tão eficazes em controle de bombas." },
  ...
  { id: "e127", inedita: true, areaGrande: "Eletrotécnica", assunto: "NBR 5410", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I = \dfrac{P}{V} = \dfrac{6000}{220} \approx 27{,}3\text{ A}$$. Pela Tabela 36 da NBR 5410 para condutor de cobre PVC embutido em conduto, temperatura ambiente 30°C, para $$I_z \geq 27{,}3\text{ A}$$: seção de **6 mm²** ($$I_z = 32\text{ A}$$) ✓." },
  ...
  { id: "e128", inedita: true, areaGrande: "Eletrotécnica", assunto: "Circuitos CA", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$V_{pico} = V_{rms} \times \sqrt{2} = 127 \times 1{,}414 \approx 179{,}6\text{ V}$$. $$V_{pico-a-pico} = 2 \times V_{pico} = 2 \times 179{,}6 \approx 359{,}3\text{ V}$$. Importante: $$V_{pp} \neq 2 \times V_{rms}$$ — são grandezas diferentes!" },
  ...
  { id: "e129", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Com perda de fase (operação monofásica): o motor tenta manter o torque, mas o campo girante fica desequilibrado. Corrente nas fases restantes aumenta tipicamente para $$\sqrt{3}\text{ vezes}$$ a corrente nominal — sobreaquecimento severo e risco de queima do enrolamento." },
  ...
  { id: "e130", inedita: true, areaGrande: "Eletrotécnica", assunto: "Fator de potência", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$Q_1 = P \tan\varphi_1 = 400 \times \tan(\arccos 0{,}6) = 400 \times \dfrac{0{,}8}{0{,}6} = 400 \times 1{,}333 \approx 533{,}3\text{ kvar}$$. $$Q_2 = 400 \times \tan(\arccos 0{,}9) \approx 400 \times 0{,}484 = 193{,}7\text{ kvar}$$. $$Q_C = 533{,}3 - 193{,}7 \approx 339{,}6\text{ kvar}$$." },
  ...
  { id: "e131", inedita: true, areaGrande: "Eletrotécnica", assunto: "Iluminação industrial", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$\Phi = \dfrac{E \times A}{C_u \times F_m} = \dfrac{500 \times 600}{0{,}65 \times 0{,}80} = \dfrac{300{,}000}{0{,}52} \approx 576{,}923\text{ lm}$$. Número de luminárias: $$N = \dfrac{576{,}923}{5000} \approx 115{,}4 \approx 116\text{ luminárias}$$." },
  ...
  { id: "e132", inedita: true, areaGrande: "Eletrotécnica", assunto: "Automação industrial", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Médio",
    ...
    explicacao: "Transmissor 4-20 mA para faixa 0-10 bar: $$P = \dfrac{I - 4}{16} \times P_{max} = \dfrac{8 - 4}{16} \times 10 = \dfrac{4}{16} \times 10 = 2{,}5\text{ bar}$$. Fórmula geral padrão 4-20 mA: $$PV = PV_{min} + \dfrac{I - 4}{16} \times (PV_{max} - PV_{min})$$." },
  ...
  { id: "e133", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Torque do motor de indução: $$T \propto \Phi^2 \propto V^2$$. Com tensão reduzida a 90% ($$0{,}9 V_n$$): $$T_{novo} = T_{nom} \times \left(\dfrac{0{,}9V_n}{V_n}\right)^2 = T_{nom} \times 0{,}81$$. Redução de 19% no torque disponível — pode impedir a partida de cargas com alto torque resistente." },
  ...
  { id: "e134", inedita: true, areaGrande: "Eletrotécnica", assunto: "Grandezas elétricas e magnéticas", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "As perdas no núcleo do transformador são compostas por: Perdas por histerese: $$P_h = k_h \cdot f \cdot B_{max}^{1{,}6..2{,}0}$$ e perdas por correntes parasitas (Foucault): $$P_e = k_e \cdot f^2 \cdot B_{max}^2$$. As perdas no ferro são praticamente **independentes da carga** (constantes) e dependem da **tensão de alimentação**." },
  ...
  { id: "e136", inedita: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Correntes desequilibradas entre fases indicam impedâncias diferentes — desequilíbrio de cargas ou falha no enrolamento. Maior temperatura em uma fase indica maior corrente nessa fase: $$P_{calor} = I^2 R$$. Diagnóstico com amperímetro de grampo permite identificar a fase com problema." },
  ...
  { id: "e139", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Frenagem regenerativa: $$s < 0$$ (escorregamento negativo). O motor opera acima da velocidade síncrona como gerador: $$N > N_s$$. Energia mecânica é convertida em elétrica e devolvida à rede. Usada em elevadores, pontes rolantes e veículos elétricos para recuperação de energia e controle de velocidade." },
  ...
  { id: "e140", inedita: true, areaGrande: "Eletrotécnica", assunto: "Circuitos CA", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$P_{total} = 12 + (-3) = 9\text{ kW}$$. $$\tan\varphi = \sqrt{3} \dfrac{W_1 - W_2}{W_1 + W_2} = \sqrt{3} \times \dfrac{12 - (-3)}{12 + (-3)} = \sqrt{3} \times \dfrac{15}{9} = 1{,}732 \times 1{,}667 \approx 2{,}887$$. $$\varphi = \arctan(2{,}887) \approx 70{,}9°$$. $$FP = \cos(70{,}9°) \approx 0{,}329$$." },
  ...
  { id: "e141", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Transformadores em paralelo dividem a carga inversamente proporcional às impedâncias de curto-circuito: $$S_1 : S_2 = \dfrac{1}{Z_{cc1}} : \dfrac{1}{Z_{cc2}}$$. Para operação satisfatória em paralelo: mesma relação de transformação, mesma tensão de CC% e mesma sequência de fases (trifásicos). Diferenças de CC% causam circulação de corrente mesmo sem carga." },
  ...
  { id: "e145", inedita: true, areaGrande: "Eletrotécnica", assunto: "Circuitos CA", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$THD = \dfrac{\sqrt{V_2^2 + V_3^2 + \cdots}}{V_1} \times 100 = \dfrac{\sqrt{10^2 + 5^2}}{100} \times 100 = \dfrac{\sqrt{125}}{100} \times 100 = \dfrac{11{,}18}{100} \times 100 \approx 11{,}18\%$$. THD mede o conteúdo harmônico total em relação à componente fundamental." },
  ...
  { id: "e150", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$\dfrac{F}{L} = \dfrac{\mu_0 I_1 I_2}{2\pi d} = \dfrac{4\pi\times10^{-7} \times 100 \times 100}{2\pi \times 0{,}1} = \dfrac{4\pi\times10^{-3}}{2\pi\times10^{-1}} = \dfrac{4\times10^{-3}}{2\times10^{-1}} = 2\times10^{-2}\text{ N/m} = 20\text{ mN/m}$$. Correntes paralelas no mesmo sentido se **atraem**." },
  ...
  { id: "e151", inedita: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I_{motor} = \dfrac{P}{\sqrt{3} \times V \times FP \times \eta} = \dfrac{15000}{\sqrt{3} \times 380 \times 0{,}92 \times 0{,}85} \approx 30{,}9\text{ A}$$. $$I_{resist} = \dfrac{P_R}{V} = \dfrac{2000}{220} \approx 9{,}1\text{ A}$$. $$I_{total} \approx 40\text{ A}$$ (fasorial, aproximação)." },
  ...
  { id: "e152", inedita: true, areaGrande: "Eletrotécnica", assunto: "Sistemas trifásicos", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$FP_{total} = \dfrac{FP_{deslocamento}}{\sqrt{1 + THD^2}} = \dfrac{0{,}95}{\sqrt{1 + 0{,}35^2}} = \dfrac{0{,}95}{\sqrt{1{,}1225}} = \dfrac{0{,}95}{1{,}059} \approx 0{,}897$$. O THD degrada o fator de potência total mesmo que o deslocamento seja alto." },
  ...
  { id: "e153", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Controle V/f (escalar) para Inversor de Frequência: $$\dfrac{V}{f} = \text{constante}$$. Para $$f_{saída} = 45\text{ Hz}$$: $$V_{saída} = V_{nom} \times \dfrac{f_{saída}}{f_{nom}} = 380 \times \dfrac{45}{60} = 380 \times 0{,}75 = 285\text{ V}$$. Mantém o fluxo magnético constante no motor." },
  ...
  { id: "e155", inedita: true, areaGrande: "Eletrotécnica", assunto: "NBR 5410", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Condutor de alumínio equivalente em resistência ao cobre de 50 mm²: $$A_{Al} = A_{Cu} \times \dfrac{\rho_{Al}}{\rho_{Cu}} = 50 \times \dfrac{2{,}82}{1{,}72} \approx 81{,}98 \approx 82\text{ mm}^2$$. Próxima seção padronizada de alumínio: **95 mm²**. Alumínio é mais barato mas exige seção maior e cuidado com a oxidação nas conexões." },
  ...
  { id: "e156", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instrumentação", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "Classes de exatidão de TCs (Transformadores de Corrente): **0,1 / 0,2 / 0,5 / 1 / 3 / 5** → erro máximo em % na corrente. Classe **P** (Protection): para relés de proteção — indicado pelo índice de sobreexcitação. Exemplo: 5P10 = erro de fase ≤5%, fator de sobrecorrente nominal = 10. **TP (Transformador de Potencial)**: classes 0,1; 0,2; 0,5; 1; 3." },
  ...
  { id: "e157", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica de potência", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Degradação acumulada em n semestres com taxa de 7,6% ao semestre: $$C_n = C_0 \times (1 - 0{,}076)^n = 100\% \times (0{,}924)^{10} \approx 100\% \times 0{,}456 \approx 45{,}6\%$$. Após 5 anos, a capacidade é aproximadamente **46%** da nominal — indica necessidade de substituição do banco de baterias." },
  ...
  { id: "e158", inedita: true, areaGrande: "Eletrotécnica", assunto: "Circuitos CA", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$V_{rms,total} = \sqrt{V_1^2 + V_5^2} = \sqrt{220^2 + 22^2} = \sqrt{48400 + 484} = \sqrt{48884} \approx 221{,}1\text{ V}$$. $$THD_V = \dfrac{V_5}{V_1} \times 100 = \dfrac{22}{220} \times 100 = 10\%$$." },
  ...
  { id: "e162", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$P_{entrada,IE1} = \dfrac{P_{mec}}{\eta_{IE1}} = \dfrac{90}{0{,}935} \approx 96{,}3\text{ kW}$$. $$P_{entrada,IE3} = \dfrac{90}{0{,}955} \approx 94{,}2\text{ kW}$$. $$\Delta P = 96{,}3 - 94{,}2 = 2{,}1\text{ kW}$$. Em 4380 horas/ano: $$\Delta E = 2{,}1 \times 4380 = 9198\text{ kWh/ano}}$$ de economia com o motor IE3." },
  ...
  { id: "e239", inedita: true, areaGrande: "Eletrotécnica", assunto: "Dimensionamento elétrico", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$I_b = \dfrac{I_n}{F_c} = \dfrac{42}{0{,}70} = 60\text{ A}$$. Para $$I_z \geq 60\text{ A}$$ em condutor de cobre PVC embutido em conduto: Tabela 36 NBR 5410 → seção de **16 mm²** ($$I_z = 63\text{ A}$$) ✓." },
  ...
  { id: "e240", inedita: true, areaGrande: "Eletrotécnica", assunto: "Motores elétricos", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$N_s = 1800\text{ rpm}$$. $$s_{atual} = \dfrac{1800-1710}{1800} = \dfrac{90}{1800} = 0{,}05 = 5\%$$. $$s_{nominal} = \dfrac{1800-1741}{1800} = 3{,}3\%$$. Como $$s_{atual} > s_{nominal}$$: motor operando sob sobrecarga — corrente maior e torque eletromagnético maior que o nominal." },
  ...
  { id: "e241", inedita: true, areaGrande: "Eletrotécnica", assunto: "Motores elétricos", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "A soft-starter controla a tensão aplicada ao motor por tiristores em rampa, limitando a corrente de partida. A corrente de partida típica é reduzida para $$I_p = (2\text{ a }4) \times I_n$$ (vs $$5\text{ a }8 \times I_n$$ na partida direta). O torque de partida é proporcional ao quadrado da tensão: $$T \propto V^2$$." },
  ...
  { id: "e243", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica analógica", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$A_v = -\dfrac{R_f}{R_1} = -\dfrac{100\text{k}}{10\text{k}} = -10$$. $$V_o = A_v \times V_i = -10 \times (-0{,}5) = +5\text{ V}$$. O sinal negativo no ganho indica inversão de fase: entrada negativa → saída positiva." },
  ...
  { id: "e244", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica analógica", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$V_{CE} = V_{CC} - I_C \times R_C = 12 - 8\times10^{-3} \times 1{,}2\times10^3 = 12 - 9{,}6 = 2{,}4\text{ V}$$. Como $$V_{CE} = 2{,}4\text{ V} > V_{CE,sat} \approx 0{,}2\text{ V}$$: transistor na **região ativa** (amplificação), não na saturação." },
  ...
  { id: "e245", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica analógica", banca: "CESGRANRIO (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$\text{Slew Rate}_{necessário} = 2\pi f V_{pico} = 2\pi \times 20\times10^3 \times 100 = 12{,}57\text{ V/μs}$$. O AO741 tem SR = 0,5 V/μs — **insuficiente** — causará distorção de slew rate na saída. Escolher AO com SR ≥ 13 V/μs." },
  ...
  { id: "e246", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica digital", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$13_{10} = 8+4+1 = 1101_2$$. Contador de 4 bits de 0000 a 1111 (0 a 15): partindo de 1101 (13), faltam contar 14, 15, 0, 1 = **4 pulsos** até voltar ao estado 0001 (1)... Na verdade faltam estados: 1110 (14), 1111 (15), 0000 (0) = **3 pulsos** para ir de 13 a 0 (overflow)." },
  ...
  { id: "e248", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica digital", banca: "CESPE (estilo)", ano: 2023, dificuldade: "Médio",
    ...
    explicacao: "$$Resolução = \dfrac{V_{ref}}{2^n - 1} = \dfrac{5}{2^{10}-1} = \dfrac{5}{1023} \approx 4{,}888\text{ mV}$$. Critério de Nyquist: frequência de amostragem ≥ 2× a frequência máxima do sinal. Para sinal de até 1 kHz: $$f_s \geq 2000\text{ Hz}$$." },
  ...
  { id: "e249", inedita: true, areaGrande: "Eletrotécnica", assunto: "Telecomunicações", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$|\Gamma|^2 = \dfrac{P_{ref}}{P_{inc}} = \dfrac{1}{10} = 0{,}1 \Rightarrow |\Gamma| = \sqrt{0{,}1} \approx 0{,}316$$. $$VSWR = \dfrac{1+|\Gamma|}{1-|\Gamma|} = \dfrac{1+0{,}316}{1-0{,}316} = \dfrac{1{,}316}{0{,}684} \approx 1{,}92$$." },
  ...
  { id: "e250", inedita: true, areaGrande: "Eletrotécnica", assunto: "Telecomunicações", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$FSPL = 20\log_{10}(d) + 20\log_{10}(f) + 92{,}4\text{ [dB, km, GHz]}$$. $$= 20\log_{10}(10) + 20\log_{10}(5) + 92{,}4 = 20 + 14{,}0 + 92{,}4 = 126{,}4\text{ dB}$$. $$P_r = P_t + G_t + G_r - FSPL = 30 + 20 + 20 - 126{,}4 = -56{,}4\text{ dBm}$$." },
  ...
  { id: "e252", inedita: true, areaGrande: "Eletrotécnica", assunto: "Telecomunicações", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$\text{Atenuação} = 0{,}3\text{ dB/km} \times 80\text{ km} + 4 \times 0{,}2\text{ dB} + 2 \times 0{,}5\text{ dB} = 24 + 0{,}8 + 1{,}0 = 25{,}8\text{ dB}$$. $$P_{recebida} = P_{transmitida} - A = 10 - 25{,}8 = -15{,}8\text{ dBm}$$." },
  ...
  { id: "e253", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instrumentação", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Ponte de Wheatstone em equilíbrio: $$\dfrac{R_1}{R_2} = \dfrac{R_3}{R_x} \Rightarrow R_x = \dfrac{R_2 \times R_3}{R_1} = \dfrac{2000 \times 1500}{1000} = 3000\,\Omega = 3\text{ k}\Omega$$. Em equilíbrio, a corrente no galvanômetro é nula — princípio usado para medir resistências com alta precisão." },
  ...
  { id: "e254", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instrumentação", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Difícil",
    ...
    explicacao: "$$TPF = \dfrac{FP_{deslocamento}}{\sqrt{1+THD^2}} = \dfrac{0{,}9}{\sqrt{1+0{,}4^2}} = \dfrac{0{,}9}{\sqrt{1{,}16}} = \dfrac{0{,}9}{1{,}077} \approx 0{,}835$$. A distorção harmônica (THD=40%) degrada o fator de potência verdadeiro de 0,9 para 0,835." },
  ...
  { id: "e255", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "Perdas no cobre: $$P_{Cu} \propto I^2 \propto S^2$$. Sobrecarga de 25%: $$P_{Cu,novo} = P_{Cu,nom} \times (1{,}25)^2 = 1{,}5625 \times P_{Cu,nom}$$. Aumento: **56,25%** nas perdas ôhmicas. Isso implica superaquecimento do enrolamento e redução de vida útil do transformador." },
  ...
  { id: "e257", inedita: true, areaGrande: "Eletrotécnica", assunto: "Geração e transmissão", banca: "CESPE (estilo)", ano: 2024, dificuldade: "Difícil",
    ...
    explicacao: "$$I_{sec} = I_L \times \dfrac{N_{prim}}{N_{sec}} = 50 \times \dfrac{5}{200} = 1{,}25\text{ A}$$. $$M = \dfrac{I_{sec}}{I_{pickup}} = \dfrac{1{,}25}{0{,}5} = 2{,}5$$. Na curva tempo-inversa: tempo de atuação para M=2,5 é obtido da curva característica do relé." },
  ...
  { id: "e260", inedita: true, areaGrande: "Eletrotécnica", assunto: "Automação industrial", banca: "CESGRANRIO (estilo)", ano: 2023, dificuldade: "Médio",
    ...
    explicacao: "$$0\text{x}0064 = 6\times16 + 4 = 96 + 4 = 100$$. $$0\text{x}00C8 = 12\times16 + 8 = 192 + 8 = 200$$. Em décimos de °C: $$100/10 = 10°C$$, $$200/10 = 20°C$$. Diferença: $$200 - 100 = 100$$ em hexadecimal = diferença de $$100/10 = 10°C$$ na temperatura." },
  ...
  { id: "e307", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instalações elétricas BT", banca: "CEBRASPE / TRT-6", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "A NBR 5410:2004, seção 6.2.7, estabelece queda de tensão máxima de $$\Delta V \leq 4\%$$ da tensão nominal entre a origem da instalação (quadro geral) e qualquer ponto de utilização nos circuitos terminais. Esse limite protege o bom funcionamento dos equipamentos e evita aquecimento excessivo dos condutores por correntes mais altas (consequência da queda de tensão)." },
  ...
  { id: "e308", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instalações elétricas BT", banca: "FCC / TRT-1", ano: 2023, dificuldade: "Fácil",
    ...
    respostaCorreta: 2,
    explicacao: "NBR 5410:2004 §6.2.3.1 — Seções mínimas dos condutores de fase: $$S_{min} = 1{,}5\text{ mm}^2$$ para circuitos de iluminação e $$S_{min} = 2{,}5\text{ mm}^2$$ para circuitos de tomadas de uso geral (TUG). A seção maior para TUG é necessária pois qualquer equipamento pode ser conectado, podendo demandar corrente maior que a de iluminação." },
  ...
  { id: "e309", inedita: true, areaGrande: "Eletrotécnica", assunto: "Motores elétricos", banca: "CEBRASPE / Petrobras", ano: 2023, dificuldade: "Difícil",
    ...
    respostaCorreta: 0,
    explicacao: "$$N_s = \dfrac{120f}{p} = \dfrac{120 \times 60}{4} = \dfrac{7200}{4} = 1800\text{ rpm}$$. Velocidade do rotor com escorregamento s = 3% = 0,03: $$N_r = N_s(1-s) = 1800 \times (1-0{,}03) = 1800 \times 0{,}97 = 1746\text{ rpm}$$. O escorregamento é necessário para que exista corrente induzida no rotor e, consequentemente, torque eletromagnético." },
  ...
  { id: "e310", inedita: true, areaGrande: "Eletrotécnica", assunto: "Sistemas trifásicos", banca: "FCC / TRT-2", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "Em ligação triângulo: $$V_{fase} = V_{linha} = 380\text{ V}$$. $$I_{fase} = \dfrac{V_{fase}}{|Z|} = \dfrac{380}{10} = 38\text{ A}$$. $$P_{total} = 3 \times V_f \times I_f \times \cos\varphi = 3 \times 380 \times 38 \times \cos30° = 3 \times 380 \times 38 \times 0{,}866 \approx 37{,}6\text{ kW}$$. Alternativa B (21,7 kW) corresponde a $$|Z| = 20\,\Omega$$." },
  ...
  { id: "e311", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "$$V_2 = \dfrac{V_1}{a} = \dfrac{220}{10} = 22\text{ V}$$. $$I_2 = \dfrac{S}{V_2} = \dfrac{2000}{22} \approx 90{,}9\text{ A}$$. Verificação: $$I_1 = \dfrac{S}{V_1} = \dfrac{2000}{220} = 9{,}09\text{ A}$$. Relação de correntes: $$\dfrac{I_1}{I_2} = \dfrac{1}{a} = \dfrac{1}{10}$$ — corrente é **inversamente** proporcional à relação de transformação." },
  ...
  { id: "e312", inedita: true, areaGrande: "Eletrotécnica", assunto: "Proteção de circuitos", banca: "FCC / TRT-3", ano: 2024, dificuldade: "Fácil",
    ...
    respostaCorreta: 1,
    explicacao: "O DR (IDR — Interruptor Diferencial-Residual) detecta correntes de fuga para a terra e desconecta o circuito, protegendo contra choques elétricos por contato direto (toque em parte energizada) e indireto (toque em massa que ficou energizada por falha de isolação)." },
  ...
  { id: "e313", inedita: true, areaGrande: "Eletrotécnica", assunto: "Corrente alternada", banca: "CEBRASPE / TRT-10", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "$$X_C = \dfrac{1}{2\pi f C} = \dfrac{1}{2\pi \times 60 \times 100\times10^{-6}} = \dfrac{1}{0{,}03770} \approx 26{,}5\,\Omega$$. $$|Z| = \sqrt{R^2 + X_C^2} = \sqrt{80^2 + 26{,}5^2} = \sqrt{6400 + 702{,}3} = \sqrt{7102} \approx 84{,}3\,\Omega$$. $$FP = \dfrac{R}{|Z|} = \dfrac{80}{84{,}3} \approx 0{,}949 \approx 0{,}95$$ capacitivo (a corrente **adianta** a tensão em circuitos com capacitor dominante)." },
  ...
  { id: "e314", inedita: true, areaGrande: "Eletrotécnica", assunto: "Aterramento", banca: "FCC / TRT-15", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "No esquema TN-S (S = Separated), o condutor de proteção PE e o neutro N são condutores separados e distintos em toda a instalação, desde a origem até os pontos de utilização. É o esquema mais seguro e recomendado pela NBR 5410." },
  ...
  { id: "e315", inedita: true, areaGrande: "Eletrotécnica", assunto: "Fator de potência", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "$$\varphi_1 = \arccos(0{,}7) \approx 45{,}57°$$; $$\tan\varphi_1 = 1{,}020$$. $$\varphi_2 = \arccos(0{,}95) \approx 18{,}19°$$; $$\tan\varphi_2 = 0{,}3287$$. $$Q_1 = P\tan\varphi_1 = 150 \times 1{,}020 = 153\text{ kvar}$$. $$Q_2 = P\tan\varphi_2 = 150 \times 0{,}3287 = 49{,}3\text{ kvar}$$. $$Q_C = Q_1 - Q_2 = 153 - 49{,}3 \approx 103{,}7\text{ kvar}$$." },
  ...
  { id: "e317", inedita: true, areaGrande: "Eletrotécnica", assunto: "Máquinas elétricas", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Difícil",
    ...
    respostaCorreta: 1,
    explicacao: "$$P = S \times FP = 10\text{ MVA} \times 0{,}85 = 8{,}5\text{ MW}$$. $$Q = S \times \sin\varphi = 10 \times \sin(\arccos 0{,}85)$$. Como $$\cos\varphi = 0{,}85$$: $$\sin\varphi = \sqrt{1-0{,}85^2} = \sqrt{1-0{,}7225} = \sqrt{0{,}2775} \approx 0{,}5268$$. $$Q = 10 \times 0{,}5268 = 5{,}27\text{ Mvar}$$." },
  ...
  { id: "e318", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica básica", banca: "FCC / TRT-12", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 3,
    explicacao: "Tensão de ripple em retificador com filtro capacitivo: $$V_r \approx \dfrac{I_{carga}}{f \cdot C}$$. Quando $$R_{carga}$$ diminui, $$I_{carga} = V/R_{carga}$$ aumenta — o capacitor se descarrega mais rápido entre pulsos e o ripple aumenta. Aumentar C ou f reduz o ripple. Isso explica por que retificadores com carga leve têm menor ripple." },
  ...
  { id: "e319", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instalações elétricas BT", banca: "CEBRASPE / TRT-8", ano: 2023, dificuldade: "Fácil",
    ...
    respostaCorreta: 2,
    explicacao: "NBR 5410:2004 — Número mínimo de circuitos de iluminação: 1 circuito a cada 60 m² ou fração. Para 180 m²: $$N_{min} = \left\lceil \dfrac{180}{60} \right\rceil = \left\lceil 3 \right\rceil = 3\text{ circuitos}$$." },
  ...
  { id: "e320", inedita: true, areaGrande: "Eletrotécnica", assunto: "Corrente alternada", banca: "FCC / TRT-9", ano: 2024, dificuldade: "Difícil",
    ...
    respostaCorreta: 0,
    explicacao: "$$X_L = 2\pi \times 60 \times 30\times10^{-3} = 11{,}31\,\Omega$$. $$X_C = \dfrac{1}{2\pi \times 60 \times 220\times10^{-6}} = 12{,}07\,\Omega$$. $$X = X_L - X_C = 11{,}31 - 12{,}07 = -0{,}76\,\Omega$$ (ligeiramente capacitivo). $$|Z| = \sqrt{5^2 + 0{,}76^2} = \sqrt{25{,}58} \approx 5{,}06\,\Omega$$. $$I = \dfrac{100}{5{,}06} \approx 19{,}8\text{ A}$$. Resposta A (10,0 A) seria com L=50 mH." },
  ...
  { id: "e321", inedita: true, areaGrande: "Eletrotécnica", assunto: "Medidas elétricas", banca: "CEBRASPE / Petrobras", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 2,
    explicacao: "Em ohmímetros analógicos a escala é logarítmica (não linear). A precisão da leitura é máxima na região central do arco, tipicamente entre $$1/3$$ e $$2/3$$ do fundo de escala, onde as divisões são mais espaçadas. Nas extremidades ($$0\,\Omega$$ e $$\infty\,\Omega$$), as divisões são muito comprimidas e a leitura é imprecisa — por isso seleciona-se a escala adequada." },
  ...
  { id: "e322", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "FCC / TRT-14", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 0,
    explicacao: "$$L = \dfrac{\mu_0 N^2 A}{l} = \dfrac{4\pi\times10^{-7} \times 500^2 \times 4\times10^{-4}}{0{,}2} = \dfrac{4\pi\times10^{-7} \times 2{,}5\times10^5 \times 4\times10^{-4}}{0{,}2} = \dfrac{4\pi\times10^{-7} \times 100}{0{,}2} = \dfrac{4\pi\times10^{-5}}{0{,}2} = 20\pi\times10^{-5} \approx 6{,}28\times10^{-4}\text{ H} \approx 0{,}63\text{ mH}$$. Resposta mais próxima: A." },
  ...
  { id: "e323", inedita: true, areaGrande: "Eletrotécnica", assunto: "Qualidade de energia", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Difícil",
    ...
    respostaCorreta: 1,
    explicacao: "DEC = Duração Equivalente de Interrupção por Unidade Consumidora: $$DEC = \dfrac{\sum_{i} (t_i \times n_i)}{N_{total}}$$ onde $$t_i$$ = duração da interrupção i, $$n_i$$ = número de consumidores afetados, $$N_{total}$$ = total de consumidores. Unidade: horas. Regulamentado pela ANEEL, Resolução 1.000/2021." },
  ...
  { id: "e324", inedita: true, areaGrande: "Eletrotécnica", assunto: "Proteção de circuitos", banca: "FCC / TRT-5", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "Disjuntor termomagnético — duas regiões de atuação: **Região térmica** (bimetálico): sobrecargas moderadas e prolongadas ($$1{,}1 \leq I/I_n \leq 6$$), atuação inversamente temporizada — quanto maior a sobrecarga, menor o tempo. **Região magnética** (eletromagnético): curtos-circuitos ($$I/I_n > 6\text{ a }20$$, conforme curva B/C/D), atuação instantânea (< 10 ms)." },
  ...
  { id: "e325", inedita: true, areaGrande: "Eletrotécnica", assunto: "Automação industrial", banca: "CEBRASPE / Petrobras", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 2,
    explicacao: "Na linguagem Ladder (Diagrama de Contatos), o símbolo —| |— representa um contato normalmente aberto (NA). Quando a bobina que controla esse contato é energizada, ele fecha e permite a passagem do fluxo lógico. O símbolo —|/|— é o contato normalmente fechado (NF), e ( ) representa a bobina de saída." },
  ...
  { id: "e326", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instrumentação", banca: "FCC / TRT-11", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 2,
    explicacao: "$$R(T) = R_0(1 + \alpha T)$$. Isolando T: $$T = \dfrac{R(T) - R_0}{R_0 \times \alpha} = \dfrac{138{,}5 - 100}{100 \times 0{,}00385} = \dfrac{38{,}5}{0{,}385} = 100°C$$. A Pt100 é um sensor RTD (Resistance Temperature Detector) de platina, com resistência de 100 Ω a 0°C. Muito usado em processos industriais por sua estabilidade e linearidade." },
  ...
  { id: "e327", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Difícil",
    ...
    respostaCorreta: 1,
    explicacao: "$$F = B \cdot I \cdot L \cdot \sin\theta = 0{,}8 \times 10 \times 0{,}5 \times \sin90° = 0{,}8 \times 10 \times 0{,}5 \times 1 = 4\text{ N}$$. A direção da força é dada pela regra da mão esquerda (ou $$\vec{F} = I(\vec{L} \times \vec{B})$$). A força é máxima quando o condutor é perpendicular ao campo ($$\theta = 90°$$) e nula quando paralelo." },
  ...
  { id: "e329", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica básica", banca: "CEBRASPE / Petrobras", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "$$A_v = -\dfrac{R_f}{R_1} = -\dfrac{100\text{ k}\Omega}{10\text{ k}\Omega} = -10\text{ V/V}$$. O sinal negativo indica **inversão de fase** (sinal de saída tem polaridade oposta à entrada). Para amplificador não-inversor: $$A_v = 1 + R_f/R_1 = +11\text{ V/V}$$. O AO ideal tem ganho de malha aberta infinito e impedância de entrada infinita." },
  ...
  { id: "e330", inedita: true, areaGrande: "Eletrotécnica", assunto: "Instalações elétricas BT", banca: "FCC / TRT-13", ano: 2024, dificuldade: "Fácil",
    ...
    respostaCorreta: 1,
    explicacao: "DPS (Dispositivo de Proteção contra Surtos) — também chamado TVSS ou SPD: absorve e deriva para terra a energia das sobretensões transitórias (raios e manobras), que podem atingir vários kV em microssegundos. Componentes internos: varistores (MOV) e/ou diodos TVS. Classe I (para SPDA), Classe II (para quadros gerais) e Classe III (para quadros terminais — protege equipamentos sensíveis)." },
  ...
  { id: "e331", inedita: true, areaGrande: "Eletrotécnica", assunto: "Corrente contínua", banca: "CEBRASPE / Petrobras", ano: 2024, dificuldade: "Médio",
    ...
    respostaCorreta: 0,
    explicacao: "$$R_{eq} = \dfrac{R}{n} = \dfrac{12}{3} = 4\,\Omega$$ (fórmula especial para n resistores iguais em paralelo). $$I = \dfrac{V}{R_{eq}} = \dfrac{24}{4} = 6\text{ A}$$. Verificação: cada ramo tem $$I_i = 24/12 = 2\text{ A}$$; total: $$3 \times 2 = 6\text{ A}$$ ✓. Nota: para dois resistores quaisquer: $$R_{eq} = \dfrac{R_1 R_2}{R_1 + R_2}$$." },
  ...
  { id: "e332", inedita: true, areaGrande: "Eletrotécnica", assunto: "Sistemas trifásicos", banca: "FCC / TRT-16", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 2,
    explicacao: "$$V_L = \sqrt{3} \times V_F = 1{,}7321 \times 127 = 220{,}0\text{ V}$$. Esta é a relação clássica do sistema elétrico brasileiro: rede de $$127\text{ V}/220\text{ V}$$ (monofásico bifio $$\rightarrow$$ trifásico). Nas regiões com rede de 220/380 V (padrão europeu, em expansão no Brasil): $$V_L = 1{,}732 \times 220 = 380\text{ V}$$." },
  ...
  { id: "e333", inedita: true, areaGrande: "Eletrotécnica", assunto: "Transformadores", banca: "CEBRASPE / TRT-22", ano: 2024, dificuldade: "Difícil",
    ...
    respostaCorreta: 1,
    explicacao: "Rendimento máximo quando perdas no ferro = perdas no cobre: $$x = \sqrt{\dfrac{P_{Fe}}{P_{Cu,nom}}} = \sqrt{\dfrac{500}{1500}} = \dfrac{1}{\sqrt{3}} \approx 0{,}577$$. $$S_{\eta_{max}} = x \times S_{nom} = 0{,}577 \times 75 \approx 43{,}3\text{ kVA}$$. Verificação: $$P_{Fe} = 500\text{ W} = P_{Cu}(43{,}3) = 1500 \times 0{,}577^2 = 1500/3 = 500\text{ W}$$ ✓." },
  ...
  { id: "e335", inedita: true, areaGrande: "Eletrotécnica", assunto: "Eletrônica básica", banca: "CEBRASPE / Petrobras", ano: 2023, dificuldade: "Fácil",
    ...
    respostaCorreta: 1,
    explicacao: "Com polarização direta (anodo positivo > catodo positivo), a barreira de potencial da junção PN é reduzida, permitindo a passagem de corrente elétrica convencional. O diodo apresenta baixa resistência e corrente elevada (limitada pelo circuito externo). A tensão no diodo de silício em condução é tipicamente 0,6 a 0,7 V." },
  ...
  { id: "e336", inedita: true, areaGrande: "Eletrotécnica", assunto: "Comandos elétricos", banca: "FCC / TRT-18", ano: 2023, dificuldade: "Médio",
    ...
    respostaCorreta: 1,
    explicacao: "O relé térmico possui contatos auxiliares (normalmente fechados — NF) inseridos no circuito de COMANDO, em série com a bobina do contator. Quando atua por sobrecarga, seus contatos NF abrem, desenergizando a bobina do contator, que por sua vez abre os contatos principais no circuito de potência, desligando o motor indiretamente." },
