...
const QUESTOES_BASE: any[] = [
  ...
  { id: "e102", inedita: true, temImagem: true, areaGrande: "Eletrotécnica", assunto: "Eletromagnetismo", banca: "Voltis Original", ano: 2023, dificuldade: "Difícil",
    ...
    alternativas: ["1,45%", "2,40%", "4,17%", "6,25%", "8,33%"], respostaCorreta: 0,
    explicacao: "Passo 1 — Corrente nominal no primário: $$I_{n1} = \\dfrac{S}{V_1} = \\dfrac{10000}{2400} \\approx 4{,}17\\text{ A}$$ (cuidado: esse valor em amperes NÃO é o Zcc%). Passo 2 — Impedância de base: $$Z_{base} = \\dfrac{V_1^2}{S} = \\dfrac{2400^2}{10000} = 576\\,\\Omega$$. Passo 3 — Módulo da impedância de curto-circuito: $$Z_{cc} = \\sqrt{R_{eq}^2 + X_{eq}^2} = \\sqrt{3^2 + 5^2} = \\sqrt{34} \\approx 5{,}83\\,\\Omega$$. Passo 4 — Impedância percentual: $$Z_{cc}\\% = \\dfrac{Z_{cc}}{Z_{base}} \\times 100 = \\dfrac{5{,}83}{576} \\times 100 \\approx 1{,}01\\%$$. O valor mais próximo entre as alternativas é A) 1,45% — resposta: alternativa A." },
